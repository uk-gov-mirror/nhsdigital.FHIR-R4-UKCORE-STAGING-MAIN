...
<p><b>A-D:</b></p>
<ul>
<li>{{pagelink:Extension-UKCore-AdditionalContact-Example}}</li>
<li>{{pagelink:Extension-UKCore-AddressKey-Example}}</li>
<li>{{pagelink:Extension-UKCore-AdmissionMethod-Example}}</li>
<li>{{pagelink:Extension-UKCore-AllergyIntolEnd-Example}}</li>
<li>{{pagelink:Extension-UKCore-AssociatedEncounter-Example}}</li>
<li>{{pagelink:Extension-UKCore-BirthPlace-Example}}</li>
<li>{{pagelink:Extension-UKCore-BirthSex-Example}}</li>
<li>{{pagelink:Extension-UKCore-BirthTime-Example}}</li>
<li>{{pagelink:Extension-UKCore-BodySiteReference-Example}}</li>
<li>{{pagelink:Extension-UKCore-BookingOrganization-Example}}</li>
<li>{{pagelink:Extension-UKCore-CadavericDonor-Example}}</li>
<li>{{pagelink:Extension-UKCore-CareSettingType-Example}}</li>
<li>{{pagelink:Extension-UKCore-CodingSCTDescId-Example}}</li>
...
<li>{{pagelink:Extension-UKCore-CodingSCTDescId-Example}}</li>
<li>{{pagelink:Extension-UKCore-CompositionReference-Example}}</li>
<li>{{pagelink:Extension-UKCore-ConditionEpisode-Example}}</li>
<li>{{pagelink:Extension-UKCore-ContactPreference-Example}}</li>
<li>{{pagelink:Extension-UKCore-ContactRank-Example}}</li>
<li>{{pagelink:Extension-UKCore-ContainerBackports-Example}}</li>
<li>{{pagelink:Extension-UKCore-CopyCorrespondenceIndicator-Example}}</li>
<li>{{pagelink:Extension-UKCore-Coverage-Example}}</li>
<li>{{pagelink:Extension-UKCore-CuffSize-Example}}</li>
<li>{{pagelink:Extension-UKCore-DeathNotificationStatus-Example}}</li>
<li>{{pagelink:Extension-UKCore-DeliveryChannel-Example}}</li>
<li>{{pagelink:Extension-UKCore-DeviceReference-Example}}</li>
<li>{{pagelink:Extension-UKCore-DischargeMethod-Example}}</li>
<li>{{pagelink:Extension-UKCore-DiagnosticReportMediaLinkR5-Example}}</li>
</ul>
</td><td style="border-left: 1px solid #eeeeee">
<p><b>E-L:</b></p>
<ul>
<li>{{pagelink:Extension-UKCore-EffectivePeriod-Example}}</li>
<li>{{pagelink:Extension-UKCore-EmergencyCareDischargeStatus-Example}}</li>
<li>{{pagelink:Extension-UKCore-EthnicCategory-Example}}</li>
<li>{{pagelink:Extension-UKCore-Evidence-Example}}</li>
<li>{{pagelink:Extension-UKCore-InterpreterRequired-Example}}</li>
<li>{{pagelink:Extension-UKCore-LastIssueDate-Example}}</li>
<li>{{pagelink:Extension-UKCore-LegalStatus-Example}}</li>
<li>{{pagelink:Extension-UKCore-ListWarningCode-Example}}</li>
</ul>
</td></tr>
<tr class="a-to-z"><td>
<p><b>M-P:</b></p>
<ul>
<li>{{pagelink:Extension-UKCore-MainLocation-Example}}</li>
<li>{{pagelink:Extension-UKCore-MedicalApplianceSupplier-Example}}</li>
<li>{{pagelink:Extension-UKCore-MedicationChangeSummary-Example}}</li>
<li>{{pagelink:Extension-UKCore-MedicationPrescribingOrganizationType-Example}}</li>
<li>{{pagelink:Extension-UKCore-MedicationStatementLastIssueDate-Example}}</li>
<li>{{pagelink:Extension-UKCore-MedicationTradeFamily-Example}}</li>
<li>{{pagelink:Extension-UKCore-NHSNumberUnavailableReason-Example}}</li>
<li>{{pagelink:Extension-UKCore-NHSNumberVerificationStatus-Example}}</li>
<li>{{pagelink:Extension-UKCore-Note-Example}}</li>
<li>{{pagelink:Extension-UKCore-OrganizationPeriod-Example}}</li>
<li>{{pagelink:Extension-UKCore-OtherContactSystem-Example}}</li>
<li>{{pagelink:Extension-UKCore-OutcomeOfAttendance-Example}}</li>
<li>{{pagelink:Extension-UKCore-OverseasVisitorChargingCategory-Example}}</li>
<li>{{pagelink:Extension-UKCore-ParentPresent-Example}}</li>
<li>{{pagelink:Extension-UKCore-Participant-Example}}</li>
<li>{{pagelink:Extension-UKCore-Period-Example}}</li>
<li>{{pagelink:Extension-UKCore-PharmacistVerifiedIndicator-Example}}</li>
<li>{{pagelink:Extension-UKCore-PreferredDispenserOrganization-Example}}</li>
<li>{{pagelink:Extension-UKCore-PriorityReason-Example}}</li>
<li>{{pagelink:Extension-UKCore-PriorityReason-SendingAsText-Example}}</li>
</ul>
</td><td style="border-left: 1px solid #eeeeee">
<p><b>Q-Z:</b></p> 
<ul>  
<li>{{pagelink:Extension-UKCore-RecordingSetting-Example}}</li>
<li>{{pagelink:Extension-UKCore-RepeatInformation-Example}}</li>
<li>{{pagelink:Extension-UKCore-ResidentialStatus-Example}}</li>
<li>{{pagelink:Extension-UKCore-ResponseRequest-Example}}</li>
<li>{{pagelink:Extension-UKCore-SampleCategory-Example}}</li>
<li>{{pagelink:Extension-UKCore-SampleCategory-PheobeSmitham-Example}}</li>
<li>{{pagelink:Extension-UKCore-SourceOfServiceRequest-Example}}</li>
<li>{{pagelink:Extension-UKCore-SubscriptionParameters-Example}}</li>
<li>{{pagelink:Extension-UKCore-SpecialHandling-Example}}</li>
<li>{{pagelink:Extension-UKCore-SpecimenCollectionCollector-Example}}</li>
<li>{{pagelink:Extension-UKCore-Translation-Example}}</li>
<li>{{pagelink:Extension-UKCore-TriggeredBy-Example}}</li>
<li>{{pagelink:Extension-UKCore-VaccinationProcedure-Example}}</li>
<li>{{pagelink:Extension-UKCore-VaccinationProcedure-Covid-Example}}</li>
</ul>
</td></tr>
