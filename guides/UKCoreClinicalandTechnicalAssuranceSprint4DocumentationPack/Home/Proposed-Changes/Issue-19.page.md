...
<tr>
<td>
The SNOMED CT concepts identified include invasive blood pressures
but believe this should not be in scope. If they are then as for #3297 the concepts need validation with intensive care experts to validate that the concepts for the values and the units are all available.
</td>
<td>
