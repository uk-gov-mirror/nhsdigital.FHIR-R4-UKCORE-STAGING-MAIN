...
<tr>
<td>
Health issues simple reference set (1127581000000103) is retired.
This Issue is related to the UKCoreAllergyManifestation Profile.
...
It seems that Health issues simple reference set (1127581000000103) is retired.
</td>
<td>
